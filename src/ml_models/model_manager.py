...
class ModelManager:
    ...
    def _initialize_default_models(self):
        ...
        # Models will be trained with real market data when needed
        logger.info("ModelManager initialized - models will be trained with real market data")
    
    # Sample data training removed - Models now train with real market data only
